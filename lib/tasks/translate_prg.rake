...
task prg_to_erb: :environment do | t, args |
	...
	args.ofile = args.ifile + ".erb" if not args.ofile
	...
	File.open("#{Rails.root}/#{args.ofile}", 'w') do |fd|
		fd.write header
