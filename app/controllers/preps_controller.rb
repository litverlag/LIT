class PrepsController < TableController
  ...
  def index
    ...
    respond_to do |format|
      ...
      format.json {serve_table_data(Gprod.left_outer_joins(:buch, :lektor, :preps), displayedColumns, filterableColumns, editable, notViewable, "Gprods.id", @statusColumnsEditable)}
    end
  end
